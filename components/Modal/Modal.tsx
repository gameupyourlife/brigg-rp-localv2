        ...
        <div>
            ...
            <div onClick={e => handleBGClick(e)} id="authentication-modal" className={` flex justify-center bg-black/30 overflow-x-hidden overflow-y-auto fixed  max-md:pt-20 h-full top-4 left-0 right-0 md:inset-0 z-50  items-center`}>
                <div className=" relative w-full max-w-3xl px-4 h-full md:h-auto z-10">
                    ...
                    <div id='modal-main' className="bg-white rounded-lg shadow relative dark:bg-gray-800">
                        <div className="flex flex-wrap-reverse">
                            <Image id='modal-img' alt='flavor image' src={img} width={210} height={300} className='aspect-[2/3] min-h-full max-md:hidden' />
                            <div className='flex flex-col'>

                            <div className="flex  justify-end p-2">
                                <button onClick={e => changeState()} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" >
