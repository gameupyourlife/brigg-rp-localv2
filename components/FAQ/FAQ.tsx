                ...
                <main className="relative min-h-screen flex flex-col justify-center overflow-hidden">
                    <div className="w-full max-w-2xl mx-auto px-4 md:px-6 py-24">
                        ...
                        <div className="divide-y divide-slate-200">
                            ...
                            <AccordionItem title='Wie finde ich RP-Partner?' text='Wir haben ein Community-Forum und einen Discord-Server, auf denen du andere Spieler treffen und nach RP-Partnern suchen kannst. Außerdem organisieren wir regelmäßig Events, bei denen du andere Spieler kennenlernen kannst.' />
                            ...
                            <AccordionItem title='Wie kann ich Support erhalten?' text='Wenn du Fragen hast oder Unterstützung benötigst, kannst du uns über das Kontaktformular auf unserer Website oder über unseren Discord-Server erreichen. Unser Support-Team steht dir gerne zur Verfügung.' />
                            ...
                            <AccordionItem title='Wie bleibe ich über Neuigkeiten und Events auf dem Laufenden?' text='Halte dich über unsere Website und unseren Discord-Server auf dem Laufenden. Wir posten regelmäßig Updates, Ankündigungen und Informationen zu geplanten Events.' />
