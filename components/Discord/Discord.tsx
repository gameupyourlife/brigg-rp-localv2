...
const Discord = () => {
    return (
        <section className='flex-wrap text-[var(--text)]  flex align-middle justify-center mx-auto pb-[0px]  -mb-[150px] md:-mb-[250px] pt-[10rem] -mt-[9rem]  box-border bg-black/[.4]  backdrop-blur-md' >
            <Image src={"/street_crew_member3.png"} width={500} height={500} alt="img" />
