    ...
    return (
        <div className='z-10 relative' id='factions'>
            ...
            <section className="flex justify-center align-center  pb-10 flex-wrap ">
                ...
                <HoverCard alink="#medic" cover="/Hovercards/Fire/firemanBG.png" title="/Logos/lsmd.png" character="/Hovercards/Fire/fireman.png" mImg='/Hovercards/Fire/firemanBG.png' mTitle='Fire Department' mText='In einer Stadt, in der Gefahren und Brände lauern, sind wir die Helden im Fire Department. Unsere Feuerwehrleute riskieren ihr Leben, um Brände zu löschen und Leben zu retten. Wir sind stolz darauf, die Sicherheit der Bürger von Los Santos zu gewährleisten und in Notsituationen Hilfe zu leisten.'/>
                <HoverCard alink="#medic" cover="/Hovercards/Medic/medicbg.png" title="/Logos/lsmd.png" character="/Hovercards/Medic/medic.png" mImg='/Hovercards/Medic/medicbg.png' mTitle='Medical Department' mText='In einer gefährlichen Stadt sind wir die Helden des Alltags im Medical Department. Unsere Ärzte und Krankenschwestern stehen bereit, um Leben zu retten und Schmerzen zu lindern. Wir schützen die Gesundheit und Sicherheit der Bürger von Los Santos, sei es bei Notfällen oder im Krankenhaus. Im Medical Department sind wir stolz darauf, Leben zu retten und Heilung zu bringen.'/>
                <HoverCard alink="#police" cover="/policemanBG.png" title="/Logos/PD_Logo.png" character="/swatFeatures.png" mImg='/policemanBG.png' mTitle='Police Department' mText='In einer Stadt voller Verbrechen und Herausforderungen sind wir die Beschützer im Police Department. Unsere Polizisten arbeiten rund um die Uhr, um die Sicherheit der Bürger von Los Santos zu gewährleisten. Wir setzen uns für Recht und Ordnung ein, bekämpfen das Verbrechen und stehen für Gerechtigkeit ein. Im Police Department sind wir stolz darauf, unsere Stadt zu schützen und für Frieden und Sicherheit zu sorgen.' />
                <HoverCard alink="#doj" cover="/prosecutorBG.png" title="/Logos/doj.png" character="/prosecutor.png" mImg='/prosecutorBG.png' mTitle='Department of Justice' mText='In einer Stadt voller Kriminalität und Chaos ist das Department of Justice der Hüter der Gesetze von Los Santos. Unsere engagierten Anwälte, Richter und Strafverfolgungsbeamten setzen sich für Recht und Ordnung ein. Wir kämpfen für Gerechtigkeit und den Schutz der Bürger in dieser gefährlichen Stadt.'/>
            </section>
            </div>
