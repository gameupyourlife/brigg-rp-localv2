                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-12">
                            ...
                            <div className="sm:flex sm:flex-col sm:h-full sm:justify-center ">
                                ...
                                <div className="mt-2 sm:mt-auto space-x-2.5">
                                    <a
                                        ...
                                        href="https://www.twitch.tv/drygin91"
                                        target='_blank'
                                    >
                        ...
                        <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
                            ...
                            <div className="sm:flex sm:flex-col sm:h-full sm:justify-center">
                                ...
                                <div className="mt-2 sm:mt-auto space-x-2.5">
                                    ...
                                    <a
                                        className="inline-flex justify-center items-center text-gray-500 hover:text-gray-800 dark:hover:text-gray-200"
                                        href="https://www.twitch.tv/gameupyourlife"
                                        target='_blank'
                                    >
                                        <span className="w-3.5 h-3.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" className="w-3.5 h-3.5" fill="currentColor">
                        ...
                        <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
                            ...
                            <div className="sm:flex sm:flex-col sm:h-full sm:justify-center">
                                ...
                                <a
                                        className="inline-flex justify-center items-center text-gray-500 hover:text-gray-800 dark:hover:text-gray-200"
                                        href="https://www.twitch.tv/king_lost_tv"
                                        target='_blank'
                                    >
                                        <span className="w-3.5 h-3.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" className="w-3.5 h-3.5" fill="currentColor">
                        ...
                        <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
                            ...
                            <div className="sm:flex sm:flex-col sm:h-full sm:justify-center">
                                ...
                                <a
                                        className="inline-flex justify-center items-center text-gray-500 hover:text-gray-800 dark:hover:text-gray-200"
                                        href="https://www.twitch.tv/kekksdog"
                                        target='_blank'
                                    >
                                        <span className="w-3.5 h-3.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" className="w-3.5 h-3.5" fill="currentColor">
